...
contract net75 is Ownable, Killable {
  ...
  function net75(address multisigInput, uint startBlockInput, uint endBlockInput, uint payBlockInput, uint paymentAmountInput) {
        owner = msg.sender;
