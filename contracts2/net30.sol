...
contract net30 is Ownable, Killable {
  ...
  function net30(address multisigInput, uint startBlockInput, uint endBlockInput, uint payBlockInput, uint paymentAmountInput) {
        owner = msg.sender;
