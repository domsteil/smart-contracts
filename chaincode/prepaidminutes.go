...
func (t *SimpleChaincode) Init(stub shim.ChaincodeStubInterface) pb.Response {
	fmt.Println("Prepaid Minutes Is Starting Up")
...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	} else if function == "delete_prepaidminutes" {    //deletes a prepaidminute from state
		return delete_prepaidminute(stub, args)
	} else if function == "init_prepaidminute" {      //create a new prepaidminute
		return init_prepaidminute(stub, args)
	} else if function == "set_owner" {        //change owner of a prepaidminute
		return set_owner(stub, args)
	} else if function == "init_owner"{        //create a new prepaidminute owner
		return init_owner(stub, args)
	} else if function == "read_everything"{   //read everything, (owners + prepaidminute + companies)
