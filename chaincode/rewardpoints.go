...
func (t *SimpleChaincode) Init(stub shim.ChaincodeStubInterface) pb.Response {
	fmt.Println("Reward Points Is Starting Up")
...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	} else if function == "delete_rewardpoint" {    //deletes a rewardpoint from state
		return delete_marble(stub, args)
	} else if function == "init_rewardpoint" {      //create a new rewardpoint
		return init_marble(stub, args)
	} else if function == "set_owner" {        //change owner of a rewardpoint
		return set_owner(stub, args)
	} else if function == "init_owner"{        //create a new rewardpoint owner
		return init_owner(stub, args)
	} else if function == "read_everything"{   //read everything, (owners + rewardpoints + companies)
		return read_everything(stub)
	} else if function == "getHistory"{        //read history of a rewardpoint (audit)
		return getHistory(stub, args)
	} else if function == "getRewardPointsByRange"{ //read a bunch of rewardpoints by start and stop id
