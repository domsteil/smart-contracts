...
contract net90 is Ownable, Killable {

  uint public startBlock; //contract start block (set in constructor)
  uint public endBlock; //contract end block (set in constructor)
  uint public payBlock = 9555426; // payment is due this many blocks after the startBlock (assuming 14 second blocks, this is two months )
  ...
  function net90(address multisigInput, uint startBlockInput, uint endBlockInput, uint payBlockInput, uint paymentAmountInput) {
        owner = msg.sender;
