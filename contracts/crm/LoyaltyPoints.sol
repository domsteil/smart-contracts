...
*/
contract pointRecipient { 
function receiveApproval(address _from, uint256 _value, address _token, bytes _extraData); 
}

contract LoyaltyPoints { 
/* Public variables of the point */
string public name;
...
/* Initializes contract with initial supply points to the creator of the contract */
...
name = pointName; // Set the name for display purposes 
symbol = pointSymbol; // Set the symbol for display purposes 
...
pointRecipient spender = pointRecipient(_spender);
