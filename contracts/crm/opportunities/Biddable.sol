...
contract Bid is Ownable {
  ...
  function setUpBidDetails(uint price_, uint amount_,  string opportunityName_, string opportunityOwner_, string closeDate_, string blockStart_, string type_, string industry_, string description_) {
