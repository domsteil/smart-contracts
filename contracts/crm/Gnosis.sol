...
/// @title Dapps.ai token contract
/// @author Dom Steil <dominic@dapps.ai>
contract DappsAIToken is StandardToken {
    ...
    function DappsAIToken(address dutchAuction, address[] owners, uint[] tokens)
        public
    {
        if (dutchAuction == 0)
